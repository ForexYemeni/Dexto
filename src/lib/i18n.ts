...
export const translations = {
  ar: {
    ...
    invalidCredentials: 'رقم الهاتف أو كلمة المرور غير صحيح',
    emailExists: 'البريد الإلكتروني مستخدم بالفعل',
    phoneExists: 'رقم الهاتف مستخدم بالفعل',
    invalidPhone: 'رقم الهاتف غير صالح (6-15 رقماً)',
    ...
    resetAdminPassword: 'إعادة تعيين كلمة المرور',
    newPasswordPlaceholder: 'كلمة المرور الجديدة (6 أحرف على الأقل)',
    removeAdmin: 'إزالة صلاحيات المدير',
    cannotDeletePrimaryAdmin: 'لا يمكن حذف المدير الرئيسي',
    cannotModifyPrimaryAdmin: 'لا يمكن تعديل المدير الرئيسي',
    cannotDeleteSelf: 'لا يمكنك حذف حسابك',
    cannotSuspendSelf: 'لا يمكنك إيقاف حسابك',
    adminCreated: 'تم إنشاء حساب المدير بنجاح',
    adminPasswordReset: 'تم إعادة تعيين كلمة المرور بنجاح',
    adminRemoved: 'تمت إزالة صلاحيات المدير',
    primaryAdmin: 'مدير رئيسي',
  ...
  en: {
    ...
    invalidPhone: 'Invalid phone number (6-15 digits)',
    ...
    cannotDeletePrimaryAdmin: 'Cannot delete primary admin',
    cannotModifyPrimaryAdmin: 'Cannot modify primary admin',
