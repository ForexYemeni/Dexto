...
const PLANS = [
  {
    ...
    description: 'Start your mining journey with the Basic plan',
    descriptionAr: 'ابدأ رحلتك في التعدين مع الخطة الأساسية',
    price: 50,
  ...
  },
  {
    name: 'Silver Plan',
    nameAr: 'الخطة الفضية',
    description: 'Higher returns with the Silver plan',
    descriptionAr: 'أرباح أعلى مع الخطة الفضية',
    price: 200,
  ...
  },
  {
    ...
    description: 'Excellent returns with the Gold plan',
    descriptionAr: 'عوائد ممتازة مع الخطة الذهبية',
    price: 500,
  ...
  },
  {
    ...
    description: 'Maximum returns with the Diamond plan',
    descriptionAr: 'أعلى العوائد مع الخطة الماسية',
    price: 1000,
